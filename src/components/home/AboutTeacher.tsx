      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <SectionAnimation animationType="left">
            <h2 className="text-3xl font-bold text-primary mb-6">الأستاذ ديهم عبد اللطيف</h2>
            <p className="text-lg text-gray-700 mb-4">
              أستاذ رياضيات ذو خبرة أكثر من 15 عامًا في تدريس الرياضيات لمختلف المراحل التعليمية.
              حاصل على شهادة الماجستير في الرياضيات من جامعة مرموقة،محمد خيضر بسكرة  وله العديد من الإنجازات في مجال التعليم.
            </p>
            <p className="text-lg text-gray-700 mb-6">
              يؤمن الأستاذ ديهم عبد اللطيف  أن كل طالب يمتلك القدرة على فهم وإتقان الرياضيات مع التوجيه المناسب والشرح المبسط.
