  ...
  const testimonials = [
    {
      ...
      name: "أحمد محمود",
      role: "طالب جامعي",
      content: "تعلمت الكثير من الأستاذ ديهم . طريقته في الشرح واضحة وسهلة الفهم، ساعدتني على تخطي صعوبات الرياضيات والتفوق في دراستي.",
    ...
    },
    {
      ...
      name: "سارة علي",
      role: "طالبة ثانوية",
      content: "كنت أعاني من صعوبة في فهم الرياضيات، لكن بفضل دروس الأستاذ ديهم أصبحت المادة المفضلة لدي وتحسنت درجاتي بشكل كبير.",
    ...
    },
    {
      ...
      role: "ولي أمر",
      content: "لاحظت تحسناً كبيراً في مستوى ابني بعد متابعته لدروس الأستاذ ديهم . أسلوبه التعليمي ممتاز ويراعي الفروق الفردية بين الطلاب.",
